...
RoomPrefab_Corner::RoomPrefab_Corner(std::string name) : Entity(name)
{
	...
	// Spawning Test Walls
	{
		...
		// Back Wall Collider
		{
			...
			backCollider->GetTransform()->SetGlobalPosition(glm::vec3(0, 3.0f, 9.0f));

			backCollider->AddComponent<RigidBody>();
			backCollider->GetComponent<RigidBody>()->Init(new BoxShape(glm::vec3(9.0f, 3.0f, 0.25f)), 0.0f, glm::vec3(0.0f, 0.0f, 0.0f));
		...
		// Left Wall Colliders
		{
			...
			leftCollider1->GetTransform()->SetGlobalPosition(glm::vec3(-9.0f, 3.0f, 5.0f));

			leftCollider1->AddComponent<RigidBody>();
			leftCollider1->GetComponent<RigidBody>()->Init(new BoxShape(glm::vec3(0.25f, 3.0f, 4.0f)), 0.0f, glm::vec3(0.0f, 0.0f, 0.0f));
			...
			leftCollider2->GetTransform()->SetGlobalPosition(glm::vec3(-9.0f, 3.0f, -5.0f));

			leftCollider2->AddComponent<RigidBody>();
			leftCollider2->GetComponent<RigidBody>()->Init(new BoxShape(glm::vec3(0.25f, 3.0f, 4.0f)), 0.0f, glm::vec3(0.0f, 0.0f, 0.0f));
	...
	// Spawning Test Roof
	{
		...
		theRoof->GetTransform()->SetGlobalPosition(glm::vec3(0, 0.0f, 0));
		theRoof->GetTransform()->SetScale(glm::vec3(1.f, 1.f, 1.f));

		theRoof->AddComponent<RigidBody>();
		theRoof->GetComponent<RigidBody>()->Init(new BoxShape(glm::vec3(9.25f, 0.125f, 9.25f)), 0.0f, glm::vec3(0.0f, 0.0f, 0.0f));
