...
Hedge_Large_Prefab::Hedge_Large_Prefab(std::string name) : Entity(name)
{
	// Collider
	this->AddComponent<RigidBody>();
	this->GetComponent<RigidBody>()->Init(new BoxShape(glm::vec3(0.5f, 0.875f, 2.5f)), 0.0f, glm::vec3(0.0f, 0.0f, 0.0f), RigidBodyLayer::RB_LAYER_DECORATION);
