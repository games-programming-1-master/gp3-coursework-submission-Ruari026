...
Room_2DoorStraight_Exit::Room_2DoorStraight_Exit(std::string name) : Entity(name)
{
	...
	Entity* parentPrefab = new RoomPrefab_Straight("3Door_Base", false);
	...
	Entity* entranceStairs = new ExitStairs_Prefab("Stairs");
	entranceStairs->GetTransform()->SetGlobalPosition(glm::vec3(-5.75f, -1.51f, 0));
