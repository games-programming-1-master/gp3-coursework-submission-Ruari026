...
Room_2DoorCorner_UpRight_TopFloor::Room_2DoorCorner_UpRight_TopFloor(std::string name) : Entity(name)
{
	...
	Entity* topFloor = new TopFloor_Single_Prefab("TopFloor");
	topFloor->GetTransform()->SetLocalPosition(glm::vec3(0.0f, 3.0f, 0.0f));
	topFloor->GetTransform()->SetLocalRotationQuaternion(Utility::GetRotationQuaternion((M_PI * 1.0f), glm::vec3(0, 1, 0)));
