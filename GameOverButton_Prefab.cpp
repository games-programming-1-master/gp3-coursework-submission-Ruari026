...
GameOverButton_Prefab::GameOverButton_Prefab(std::string name, std::string text, int textIndent) : Entity(name)
{
	// Main Button
	this->AddComponent(
		new ImageRenderer(
	...
	this->AddComponent<GameOverButton>();
	this->GetComponent<GameOverButton>()->SetButtonRenderer(this->GetComponent<ImageRenderer>());
